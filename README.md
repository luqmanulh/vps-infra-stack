...
Ensure Docker Engine and the Docker Compose plugin are installed on your VPS. Please follow the [Official Docker Installation Guide](https://docs.docker.com/engine/install/).
